  ...
  perSystem = { inputs', lib, pkgs, self', system, ... }: rec {
    ...
    devShells.androidDev = pkgs.mkShell {
      ...
      in ''
        ...
        export BINDGEN_EXTRA_CLANG_ARGS_aarch64_linux_android="--sysroot=${prebuiltPath}/sysroot -I${prebuiltPath}/sysroot/usr/include/aarch64-linux-android  -I${prebuiltPath}/lib/clang/19/include -I${prebuiltPath}/sysroot/usr/include" 
        ...
        export BINDGEN_EXTRA_CLANG_ARGS_i686_linux_android="--sysroot=${prebuiltPath}/sysroot -I${prebuiltPath}/sysroot/usr/include/i686-linux-android  -I${prebuiltPath}/lib/clang/19/include -I${prebuiltPath}/sysroot/usr/include"
        ...
        export BINDGEN_EXTRA_CLANG_ARGS_x86_64_linux_android="--sysroot=${prebuiltPath}/sysroot -I${prebuiltPath}/sysroot/usr/include/x86_64-linux-android  -I${prebuiltPath}/lib/clang/19/include -I${prebuiltPath}/sysroot/usr/include" 
        ...
        export BINDGEN_EXTRA_CLANG_ARGS_armv7_linux_androideabi="--sysroot=${prebuiltPath}/sysroot -I${prebuiltPath}/sysroot/usr/include/arm-linux-androideabi -I${prebuiltPath}/lib/clang/19/include -I${prebuiltPath}/sysroot/usr/include"
